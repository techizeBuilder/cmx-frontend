...
<template>
  ...
  <div class="metodo" id="metodo">
    ...
    <div class="circle">
      ...
      >
        <div
          @click="handlePointOfImpact('FrontCenter')"
          :class="{ disabled: edit }"
        >
          A
        </div>
      ...
      >
        <div
          @click="handlePointOfImpact('RTFront')"
          :class="{ disabled: edit }"
        >
          B
        </div>
      ...
      >
        <div
          @click="handlePointOfImpact('RearCenter')"
          :class="{ disabled: edit }"
        >
          E
        </div>
      ...
      >
        <div
          @click="handlePointOfImpact('LTFront')"
          :class="{ disabled: edit }"
        >
          H
        </div>
      ...
      >
        <div
          @click="handlePointOfImpact('Windshield')"
          :class="{ disabled: edit }"
        >
          I
        </div>
