...
const handleEdit = () => {
  showSuccessToast(
    `You have been redirected to the ${storeCustomerDetails.value.firstName.toUpperCase()}, ${storeCustomerDetails.value.lastName.toUpperCase()} profile.`
  );
  router.push(`/customeridprofile/${storeCustomerDetails.value._id}`);
};
</script>
<template>
      ...
      <div class="col-lg-12 col-rowset">
        <div class="d-lg-flex align-items-end gap-4 mb-4 justify-content-end">
          <div class="d-flex align-items-end gap-4 justify-content-end">
            <div class="d-flex align-items-end gap-4 justify-content-end">
              <a
                :href="`/customeridprofile/${storeCustomerDetails?._id}`"
                target="_blank"
        ...
        <div class="mt-3">
          ...
          <div class="customerXBox">
            <input
              class="form-control"
              type="text"
              :value="storeCustomerDetails?.phone"
              :disabled="true"
            />
          </div>
        </div>
        <div class="mt-3">
          ...
          <div class="customerXBox">
            <input
              class="form-control"
              type="text"
              :value="storeCustomerDetails?.phone2"
              :disabled="true"
            />
          </div>
        </div>
