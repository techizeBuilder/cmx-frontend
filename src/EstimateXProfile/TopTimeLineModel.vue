...
<template>
  ...
  <div
    ...
    tabindex="-1"
    role="dialog"
    aria-labelledby="TimeLineModelTitle"
    aria-hidden="true"
              ...
              <div class="d-flex justify-content-between p-2">
                ...
                <div class="form-check form-switch manisFS mr-0">
                  <input
                    ...
                    id="flexSwitchCheckChecked1"
                    v-model="allComp"
                    @click="() => openModal('TimeLineModelCheck')"
                  />
                </div>
              </div>
            </div>
  ...
  <div
    class="modal fade"
    id="TimeLineModelCheck"
    tabindex="-1"
    role="dialog"
    aria-labelledby="TimeLineModelCheckTitle"
    aria-hidden="true"
    data-bs-backdrop="static"
    data-bs-keyboard="false"
  >
                ...
                <div class="silde">
                  ...
                  >
                    ...
                    <button
                      ...
                      class="btn-close"
                      data-bs-dismiss="modal"
                      @click="closeModal('TimeLineModelCheck')"
                    ></button>
                  </div>
                </div>
              </div>
