...
import ProgressBarDocumentModel from "./ProgressBarDocumentFolderxModel.vue";
...
onMounted(() => {
  const documentModel = document.getElementById("DocumentUploadFolderXModule");
  if (documentModel) {
...
<template>
  <div class="modal" id="DocumentUploadFolderXModule">
