...
const openModal = () => {
  const modalElement = document.getElementById("DocumentProgressBarFolderXModule");
...
const openEditModel = (id) => {
  ...
  const modalElement = document.getElementById("DocumentEditModuleFolderX");
  const modal = new bootstrap.Modal(modalElement);
  modal.show();
};
...
onMounted(() => {
  const documentModel = document.getElementById("DocumentProgressBarFolderXModule");
  if (documentModel) {
...
onBeforeUnmount(() => {
  document
    .getElementById("DocumentProgressBarFolderXModule")
...
<template>
  <loading
    ...
    color="#E6F0FF"
  />
  <div class="modal" id="DocumentProgressBarFolderXModule">
  ...
  <div
    class="modal fade"
    id="DocumentEditModuleFolderX"
    tabindex="-1"
    aria-labelledby="DocumentEditModuleFolderXLabel"
    aria-hidden="true"
