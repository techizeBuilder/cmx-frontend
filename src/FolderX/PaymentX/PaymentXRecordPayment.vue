...
import PaymentModule from "./FolderXPaymentModel.vue";
...
<style>
.tooltipPaymentFolderXPay {
  position: relative;
  opacity: 1;
}

.tooltipPaymentFolderXPay .tooltipPaymentFolderXPaytext {
  visibility: hidden;
  width: 120px;
  ...
  margin-left: -60px;
  bottom: 100%;
  /* Position the tooltipPaymentFolderXPay */
  position: absolute;
  z-index: 1;
}

.tooltipPaymentFolderXPay:hover .tooltipPaymentFolderXPaytext {
  visibility: visible;
}
</style>
