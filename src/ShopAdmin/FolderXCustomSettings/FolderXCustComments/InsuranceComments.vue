...
const handleAdd = handleSubmit(async (value) => {
  try {
    ...
    value.commentCategory = "Insurance";
    ...
    emit("elementAdded");
    const closeButton = document.getElementById("closeCommentModelInsurance");
    closeButton.click();
    resetForm();
  } catch (error) {
    handleError(error);
    ...
    <div class="d-flex align-items-center gap-3 justify-content-between">
      ...
      <div class="d-flex justify-content-end gap-3">
        <button
          ...
          data-bs-target="#insuranceSetting"
          @click="
            () => {
              addComment = true;
              resetForm();
      ...
      <div class="card mx-auto">
        <div class="card-body p-3">
          <div class="d-flex mb-1 justify-content-between align-items-center">
            <h6 class="m-0 fw-bold">Insurance {{ Index + 1 }}</h6>
              ...
              <div class="col-sm-4 mb-4">
                <div class="card mx-auto">
                  <div class="card-body p-3">
                    ...
                    >
                      <h6 class="m-0 fw-bold">Add Customer Insurance</h6>
                      <div class="form-check form-switch">
                        <button
                          type="button"
                          class="btn btn-light px-4"
                    ...
                    <label for="text" class="form-label">Insurance Title</label>
