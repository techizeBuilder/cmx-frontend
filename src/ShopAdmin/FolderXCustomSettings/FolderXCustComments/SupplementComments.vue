...
const handleAdd = handleSubmit(async (value) => {
  try {
    ...
    value.commentCategory = "Supplement";
    ...
    emit("elementAdded");
    const closeButton = document.getElementById("closeCommentModelSupplement");
    closeButton.click();
    resetForm();
  } catch (error) {
    handleError(error);
...
<template>
    ...
    <div class="d-flex align-items-center gap-3 justify-content-end">
      <div class="d-flex justify-content-end gap-3">
        <button
          ...
          data-bs-target="#supplementSettings"
          @click="
            () => {
              addComment = true;
              resetForm();
      ...
      <div class="card mx-auto">
        <div class="card-body p-3">
          <div class="d-flex mb-1 justify-content-between align-items-center">
            <h6 class="m-0 fw-bold">Supplement {{ Index + 1 }}</h6>
  ...
  <div
    ...
    id="supplementSettings"
    tabindex="-1"
    aria-labelledby="supplementSettingsLabel"
    aria-hidden="true"
  >
              ...
              <div class="header-nom">
                <div class="silde">
                  ...
                  >
                    ...
                    <button
                      id="closeCommentModelSupplement"
                      type="button"
                      class="btn-close"
              ...
              <div class="col-sm-4 mb-4">
                <div class="card mx-auto">
                  <div class="card-body p-3">
                    ...
                    >
                      <h6 class="m-0 fw-bold">Add Customer Supplement</h6>
                      <div class="form-check form-switch">
                        <button
                          type="button"
                          class="btn btn-light px-4"
