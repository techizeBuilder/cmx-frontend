...
const handleAdd = handleSubmit(async (value) => {
  try {
    ...
    emit("elementAdded");
    const closeButton = document.getElementById("closeCommentModelRepair");
    closeButton.click();
    resetForm();
  } catch (error) {
    handleError(error);
...
<template>
      ...
      <div class="card mx-auto">
        <div class="card-body p-3">
          <div class="d-flex mb-1 justify-content-between align-items-center">
            <h6 class="m-0 fw-bold">Repairs {{ Index + 1 }}</h6>
  ...
  <div
    ...
    id="repairSettings"
    tabindex="-1"
    aria-labelledby="repairSettingsLabel"
    aria-hidden="true"
  >
              ...
              <div class="col-sm-4 mb-4">
                <div class="card mx-auto">
                  <div class="card-body p-3">
                    ...
                    >
                      <h6 class="m-0 fw-bold">Add Customer Repairs</h6>
                      <div class="form-check form-switch">
                        <button
                          type="button"
                          class="btn btn-light px-4"
                    ...
                    <label for="text" class="form-label">Repairs Title</label>
                    ...
                    <div class="card MsgDiscard mt-3">
                      <label for="text" class="form-label p-1"
                        >Repairs<span v-if="commentErrorMessage" class="errors"
                          >*</span
                        >
                      </label>
                      <textarea
