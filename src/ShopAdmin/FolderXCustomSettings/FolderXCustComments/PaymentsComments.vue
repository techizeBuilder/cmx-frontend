...
const handleAdd = handleSubmit(async (value) => {
  try {
    ...
    value.commentCategory = "Payments";
    ...
    emit("elementAdded");
    const closeButton = document.getElementById("closeCommentModelPayment");
    closeButton.click();
    resetForm();
  } catch (error) {
    handleError(error);
...
<template>
    ...
    <div class="d-flex align-items-center gap-3 justify-content-end">
      <div class="d-flex justify-content-end gap-3">
        <button
          ...
          data-bs-target="#paymentSettings"
          @click="
            () => {
              addComment = true;
              resetForm();
      ...
      <div class="card mx-auto">
        <div class="card-body p-3">
          <div class="d-flex mb-1 justify-content-between align-items-center">
            <h6 class="m-0 fw-bold">Payments {{ Index + 1 }}</h6>
  ...
  <div
    ...
    id="paymentSettings"
    tabindex="-1"
    aria-labelledby="paymentSettingsLabel"
    aria-hidden="true"
  >
              ...
              <div class="col-sm-4 mb-4">
                <div class="card mx-auto">
                  <div class="card-body p-3">
                    ...
                    >
                      <h6 class="m-0 fw-bold">Add Customer Payments</h6>
                      <div class="form-check form-switch">
                        <button
                          type="button"
                          class="btn btn-light px-4"
                    ...
                    <label for="text" class="form-label">Payments Title</label>
                    ...
                    <div class="card MsgDiscard mt-3">
                      <label for="text" class="form-label p-1"
                        >Payments<span v-if="commentErrorMessage" class="errors"
                          >*</span
                        >
                      </label>
                      <textarea
