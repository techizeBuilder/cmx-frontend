...
const schema = yup.object().shape({
  title: yup.string().required("Survey Request Title is required"),
  data: yup.string().required("Survey Request is required"),
});
...
const ChatlinkInviteData = ref([
  //   {
  //     title: "5 Star Survay",
  //     data: `We want to thank you for trusting us with your vehicle. Please take a moment to provide your 5 star review.
  //          <br /><br />
  //          Begin Review Google Rating  <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>`,
  //   },
  //   {
  //     title: `&nbsp;`,
  //     data: "",
...
const handleAdd = handleSubmit(async (value) => {
  try {
    ...
    const closeButton = document.getElementById(
      "closeCommentModelSurveyRequest"
    );
    closeButton.click();
    resetForm();
  } catch (error) {
...
<template>
    ...
    <div class="d-flex align-items-center gap-3 justify-content-end">
      <div class="d-flex justify-content-end gap-3">
        <button
          ...
          data-bs-target="#SurveyRequestMessage"
          @click="
            () => {
              addComment = true;
              resetForm();
      ...
      <div class="card mx-auto">
        <div class="card-body p-3">
          <div class="d-flex mb-1 justify-content-between align-items-center">
            <h6 class="m-0 fw-bold">Survey Request {{ Index + 1 }}</h6>
  ...
  <div
    ...
    id="SurveyRequestMessage"
    tabindex="-1"
    aria-labelledby="SurveyRequestMessageLabel"
    aria-hidden="true"
  >
              ...
              <div class="header-nom">
                <div class="silde">
                  ...
                  >
                    ...
                    <button
                      id="closeCommentModelSurveyRequest"
                      type="button"
                      class="btn-close"
              ...
              <div class="col-sm-4 mb-4">
                <div class="card mx-auto">
                  <div class="card-body p-3">
                    ...
                    >
                      <h6 class="m-0 fw-bold">Add Survey Request</h6>
                      <div class="form-check form-switch">
                        <button
                          type="button"
                          class="btn btn-light px-4"
