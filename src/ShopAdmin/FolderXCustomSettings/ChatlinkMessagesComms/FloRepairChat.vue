...
const schema = yup.object().shape({
  title: yup.string().required("Repair Chat Title is required"),
  data: yup.string().required("Repair Chat is required"),
});
...
const handleAdd = handleSubmit(async (value) => {
  try {
    ...
    emit("elementAdded");
    const closeButton = document.getElementById("closeCommentModelRepairChat");
    closeButton.click();
    resetForm();
  } catch (error) {
    handleError(error);
...
<template>
    ...
    <div class="d-flex align-items-center gap-3 justify-content-end">
      <div class="d-flex justify-content-end gap-3">
        <button
          ...
          data-bs-target="#RepairChatMessage"
          @click="
            () => {
              addComment = true;
              resetForm();
      ...
      <div class="card mx-auto">
        <div class="card-body p-3">
          <div class="d-flex mb-1 justify-content-between align-items-center">
            <h6 class="m-0 fw-bold">Repair Chat {{ Index + 1 }}</h6>
  ...
  <div
    ...
    id="RepairChatMessage"
    tabindex="-1"
    aria-labelledby="RepairChatMessageLabel"
    aria-hidden="true"
  >
              ...
              <div class="header-nom">
                <div class="silde">
                  ...
                  >
                    ...
                    <button
                      id="closeCommentModelRepairChat"
                      type="button"
                      class="btn-close"
              ...
              <div class="col-sm-4 mb-4">
                <div class="card mx-auto">
                  <div class="card-body p-3">
                    ...
                    >
                      <h6 class="m-0 fw-bold">Add Repair Chat</h6>
                      <div class="form-check form-switch">
                        <button
                          type="button"
                          class="btn btn-light px-4"
