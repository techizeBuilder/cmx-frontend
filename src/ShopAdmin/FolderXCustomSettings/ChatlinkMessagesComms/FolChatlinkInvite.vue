...
const schema = yup.object().shape({
  title: yup.string().required("Chatlink Invite Title is required"),
...
const ChatlinkInviteData = ref([
  ...
  //     data:
  //       "We first want to take a moment to thank you for trusting us with your vehicle. If you have any questions please contact us via our Chatlink or by phone.",
  //     Default: "Default #1",
  //   },
  //   {
  //     title: "PhotoX Invite Message",
  //     data:
  //       "Please take a moment to begin the Virtual Photo process by selecting the “PhotoX” icon.",
  //   },
  //   {
  //     title: "E-Sign Invite Message",
  //     data:
  //       "Please take a moment e-sign the authorization for repairs via the Electronic Signature found in the lower section of this page “E-Sign”.",
  //   },
  //   {
  //     title: "Vehicle Arrival - Tow Message",
  //     data:
  //       "Vehicle Update: We are wanting to inform you that your vehicle has arrived by tow. We will check in your vehicle and will provide you with an update soon. If you have any questions please contact us via our Chatlink or by phone.",
  //   },
  //   {
  //     title: "Welcome Message",
  //     data: "",
...
const handleAdd = handleSubmit(async (value) => {
  try {
    ...
    const closeButton = document.getElementById(
      "closeCommentModelChatlinkInvite"
    );
    closeButton.click();
    resetForm();
  } catch (error) {
...
<template>
    ...
    <div class="d-flex align-items-center gap-3 justify-content-end">
      <div class="d-flex justify-content-end gap-3">
        <button
          ...
          data-bs-target="#ChatlinkInviteMessage"
          @click="
            () => {
              addComment = true;
              resetForm();
      ...
      <div class="card mx-auto">
        <div class="card-body p-3">
          <div class="d-flex mb-1 justify-content-between align-items-center">
            <h6 class="m-0 fw-bold">Chatlink Invite {{ Index + 1 }}</h6>
  ...
  <div
    ...
    id="ChatlinkInviteMessage"
    tabindex="-1"
    aria-labelledby="ChatlinkInviteMessageLabel"
    aria-hidden="true"
  >
              ...
              <div class="header-nom">
                <div class="silde">
                  ...
                  >
                    ...
                    <button
                      id="closeCommentModelChatlinkInvite"
                      type="button"
                      class="btn-close"
              ...
              <div class="col-sm-4 mb-4">
                <div class="card mx-auto">
                  <div class="card-body p-3">
                    ...
                    >
                      <h6 class="m-0 fw-bold">Add Chatlink Invite</h6>
                      <div class="form-check form-switch">
                        <button
                          type="button"
                          class="btn btn-light px-4"
