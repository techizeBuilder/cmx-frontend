    ...
    <template #content-0>
      <v-container fluid>
        <v-row justify="end">
          ...
          <v-col cols="12">
            <custom-data-table
              id="readyForPickupTable"
              :headers="headers"
              :items="readyForPickupList"
            />
          </v-col>
        </v-row>
      </v-container>
...
const tabs = ref([{ title: 'Ready' }]);
const customFieldValue = ref('');
const readyForPickupList = ref([]);
const headers = ref([
  { title: 'RO #', value: '$$default', valueFrom: 'ro' },
  { title: 'RO Status', value: '$$default', valueFrom: 'roStatus' },
  { title: 'Delivered', value: '$$default', valueFrom: 'delivered' },
  { title: 'Date', value: '$$default', valueFrom: 'date' },
  { title: 'Notified', value: '$$default', valueFrom: 'notified' },
  {
    title: 'Days Completed',
    value: '$$default',
    valueFrom: 'daysCompleted',
  },
  ...
  { title: 'Insurance', value: '$$default', valueFrom: 'insurance' },
]);
</script>
