...
<template>
    <div class="px-3 mt-4">
        <div class="text-center d-flex align-items-end gap-5 justify-content-end">
            <p class="m-0">Vendor Link</p>
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="mySwitch" name="darkmode" checked="checked" value="yes"
                    style="font-size: 25px;">
            </div>
        </div>
        <div class="mt-4">
            <div class="row px-lg-5 pt-4 pt-sm-0 ">
                <div class="col-sm-12 col-md-6 col-lg-5 pe-5">
                    <h6 class="mt-4">New Vendor#: XXXXXXX</h6>
                    <div class="mt-4">
                    ...
                    <div class="mt-3">
                        <p class="datexlable">Vendor Website</p>
                        <div class="customerXBox">
                            <input class="form-control" type="text" />
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-5 venderLine px-5">
                    <div class="mt-5 pt-3">
